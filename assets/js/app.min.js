...
document.addEventListener('DOMContentLoaded', function() {
    var selectAllCheckbox = document.getElementById('customCheckAll');
    var customCheckboxes = document.getElementsByClassName('customCheckbox');

    selectAllCheckbox.addEventListener('change', function() {
        for (var i = 0; i < customCheckboxes.length; i++) {
            customCheckboxes[i].checked = selectAllCheckbox.checked;
        }
    });
});
